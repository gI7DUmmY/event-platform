  ...
  return (
    <div className='group relative flex flex-col min-h-[380px] w-full max-w-[400px] overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]'>
      <Link
        ...
        className='flex-center flex-grow bg-grey-50 bg-cover bg-center text-grey-50'
      />

      {isEventCreator && !hidePrice && (
        <div className='absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-white shadow-sm p-3 transition-all'>
